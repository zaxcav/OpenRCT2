...
int object_entry_group_encoding[] = {
	...
	rct_wall_scenery_entry				*gWallEntries[128];
	rct_banner							*gBannerEntries[32];
	rct_path_type						*gFootpathEntries[16];
...
const rct_object_entry_group object_entry_groups[] = {
	...
	(void**)(gWallEntries				), (rct_object_entry_extended*)(0x00F3F03C + (508 * 20)),	// walls			0x009AD794, 0xF417EC
	(void**)(gBannerEntries				), (rct_object_entry_extended*)(0x00F3F03C + (636 * 20)),	// banners			0x009AD994, 0xF421EC
